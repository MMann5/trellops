...
// import productImgUrl from '../assets/imgs'
        ...
        <main className='home-container'>
            ...
            <section className='hero'>
              <div className='hero-info'>
                ...
                <p>
                  ...
                  unique—accomplish it all with Bambello.
                </p>
                <Link
                  to='/board/60bb8a47bfc2a07e2ada4b0f'
          ...
          <section className='product'>
            <div className='product-info'>
              ...
              <p>
                Start with a Bambello board, lists, and cards.
            ...
            <div>{/* <img src={productImgUrl} alt="" /> */}</div>
          </section>
        </main>
      </div>
    );
